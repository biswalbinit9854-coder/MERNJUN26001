...
function Card({ car, bike, volvo }) {
  return (
    <div className='w-[250px] p-2 shadow-2xl rounded-lg hover:scale-105 transition-all duration-500 place-items-center m-2'>
      ...
      <button className='p-3 w-full bg-black rounded-xl mt-2 text-white font-bold hover:bg-black-400 cursor-pointer rounded-lg'>
        View Page
      </button>
    </div>
  );
...
export default Card;car,bike,volvo
